...
# Configuration Script – mSafe-1 - Rev. A

This **Configuration** script is designed for the **mSafe-1** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – mSafe-1 Rev. A

Este script de **Configuration** está diseñado para el modelo **mSafe-1** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
